...
extern const uint8_t webLogo_start[] asm("_binary_webLogo_start");
extern const uint8_t webLogo_end[] asm("_binary_webLogo_end");
...
static void task_wifi(void* pvParameters){ 
    ...
    ESP_LOGI(WIFI_TASK_TAG, "Wait4MonitorTask");

    //wait4MonitorTask();

    ESP_LOGI(WIFI_TASK_TAG, "initWifiSoftAP");
    
    initWifiSoftAP();

    ESP_LOGI(WIFI_TASK_TAG, "init_mDNS");

    init_mDNS();

    ESP_LOGI(WIFI_TASK_TAG, "initHttpServer");
